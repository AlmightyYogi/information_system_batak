...
@section('title', 'Sejarah Batak Toba')

@section('body-class', 'bg-sejarah')
...
<div class="dashboard">
    ...
    <div class="container sejarah-content">
        ...
        <p>
            Dengan sejarah yang kaya dan budaya yang beragam, masyarakat Batak Toba terus melestarikan warisan mereka 
            sambil beradaptasi dengan perkembangan zaman. Warisan ini tidak hanya berperan bagi identitas mereka sendiri, 
            tetapi juga bagi kekayaan budaya Indonesia secara keseluruhan.
        </p>
    </div>
</div>
